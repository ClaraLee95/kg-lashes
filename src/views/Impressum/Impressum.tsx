		...
		<div>
			<div className="impressumContainer">
				...
				<div className="impressumText">
					<div className="impressumTextContainer">
						<div>
							<div className="impressumTextSubheader">
								Angaben gemäß § 5 TMG:
							</div>
							KG Aesthetic Lashes <br />
							Katharina Gleixner <br />
							Telefon: 0163 1320591 <br />
							E-Mail: folgt
						</div>
						<br />
						<div>
							<div className="impressumTextSubheader">Vertreten durch:</div>
							Katharina Gleixner <br />
						...
						<div>
							...
							Katharina Gleixner, 85307 Paunzhausen
						</div>
					</div>
					<div className="impressumTextContainer">
						<div className="impressumTextHeader">
					...
					<div className="impressumTextContainer">
						...
						<div>
							<div className="impressumTextSubheader">Haftung für inhalte</div>
						...
						<br />
						<div>
							<div className="impressumTextSubheader">Haftung für Links</div>
						...
						<br />
						<div>
							<div className="impressumTextSubheader">Urheberrecht</div>
						...
						<br />
						<div>
							<div className="impressumTextSubheader">Bildnachweise</div>
							Folgt
						</div>
					</div>
					<div className="impressumTextContainer">
						<div className="impressumTextHeader">1. Datenschutzerklärung</div>
						<div>
							<div className="impressumTextSubheader">Allgemeine Hinweise</div>
						...
						<div>
							...
							widersprechen. Über die Widerspruchsmöglichkeiten werden wir Sie
					...
					<div className="impressumTextContainer">
						...
						<div>
							<div className="impressumTextSubheader">Datenschutz</div>
					...
					<div className="impressumTextContainer">
						...
						<div>
							<div className="impressumTextSubheader">Server-Log-Dateien</div>
						...
						<div>
							<div className="impressumTextSubheader">
								Kontaktformular und Datenblattformular
							</div>
							...
							der in das Kontaktformular eingegebenen Daten erfolgt somit
